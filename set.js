...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "PRINCE-MDX~oEtLIhslMsV91CL9XP5z", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
...
OWNER_NAME: process.env.OWNER_NAME || "walz", // Input Yours custom...(Maintain font for Flow)
